        ...
        {elements.map(el => (
          ...
          >
            {el.type === 'image'
              ...
              : el.type === 'table'
              ? <table className="table-fixed border border-collapse border-gray-500 bg-white">
                  <tbody>
                    {el.content.map((row, rowIndex) => (
                      <tr key={rowIndex}>
                        {row.map((cell, colIndex) => (
                          <td key={colIndex} className="border border-gray-400 px-2 py-1">{cell}</td>
                        ))}
                      </tr>
                    ))}
                  </tbody>
